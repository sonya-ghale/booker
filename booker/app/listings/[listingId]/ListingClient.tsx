// // yup what will i see after i click listing box
// 'use client';
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 md:gap-10 mt-6">
            ...
            <div className="order-first mb-10 md:order-last md:col-span-3">
              ...
              {sessionUrl && (
                <div className='cursor-pointer transition hover:bg-yellow-100 mt-10 md:col-span-10'>
                  <p>Payment URL:</p>
                  ...
                  <p>Please click this url for doing the payment and reserve your desire room</p>
                </div>
              )}
